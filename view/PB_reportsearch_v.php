...
if($this->session->userdata('is_login')) {
		...
		<div class="panel panel-info">
			...
			<div class="panel-body">
				<div class="col-md-offset-1">
					<span class="label label-primary from_label">From</span>
					<span class="label label-primary to_label">To</span>
					</div>
					<form class="form-inline" role="form">
						...
						<div class="form-group col-md-6 from_date">
							<!-- <form class="form-inline" role="form"> -->
	...
	<div class="col-md-8">
		<div class="panel panel-info">
			...
			<div class ="btn-toolbar col-md-offset-6 col-md-8 toolbar_position" select multiple="multiple">
